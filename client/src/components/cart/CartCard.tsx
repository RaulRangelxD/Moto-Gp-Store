...
export function CardProductsInCart({ Product }) {
  ...
  return (
    <View className="grid md:grid-flow-col w-11/12 h-80 md:h-64 lg:h-60 justify-center items-center shadow-black shadow-md lg:justify-between self-center lg:px-12">
      <View className="lg:grid flex flex-col lg:grid-flow-col items-center lg:mb-5 lg:gap-3  justify-center ">
        ...
        />
        <View className="flex-col lg:ml-5 lg:mr-2">
      ...
      <View className="md:ml-10 flex-row md:flex-col justify-center items-center space-x-2 md:space-x-0">
        <View className="flex-row space-x-2 items-center justify-between md:justify-center md:px-1.5 rounded-3xl bg-primary w-36 md:w-full px-3">
          ...
          <Pressable className="active:scale-110 transition-transform">
            <MayusIcon className="text-white" />
          </Pressable>
        </View>
        <Pressable
          onPress={() => navigation.navigate('Buy')}
          className="md:mt-2 bg-secondary p-1.5 rounded-full active:bg-secondary/70  w-36 md:w-full transition-all active:scale-105"
        >
