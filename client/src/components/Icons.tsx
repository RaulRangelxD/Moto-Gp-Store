...
export const ShoppingBagIcon = ({ className }: IconType) => {
  return (
    <FontAwesome name="shopping-bag" size={24} className={`${className}`} />
  )
}
...
export const ShoppingCartIcon = ({ className }: IconType) => {
  return (
    <FontAwesome name="shopping-cart" size={24} className={`${className}`} />
  )
}

export const MinusIcon = ({ className }: IconType) => {
  return <FontAwesome name="minus" size={12} className={`${className}`} />
}

export const MayusIcon = ({ className }: IconType) => {
  return <FontAwesome name="plus" size={12} className={`${className}`} />
}
...
export const ChevronLeftIcon = ({ className }: IconType) => {
  return (
    <FontAwesome name="chevron-left" size={24} className={`${className}`} />
  )
}
